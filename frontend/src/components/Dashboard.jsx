...
export default function Dashboard() {
  ...
  const stages = [
    {
      name: "Profund",
      value: Math.round((data.sleep_deep_ratio ?? 0) * 100),
      fill: "#4f46e5",
    },
    {
      name: "Lleuger",
      value: Math.round((data.sleep_light_ratio ?? 0) * 100),
      fill: "#6366f1",
    },
    {
      name: "REM",
      value: Math.round((data.sleep_rem_ratio ?? 0) * 100),
      fill: "#818cf8",
    },
    {
      name: "Despert",
      value: Math.round((data.sleep_wake_ratio ?? 0) * 100),
      fill: "#c7d2fe",
    },
  ];
